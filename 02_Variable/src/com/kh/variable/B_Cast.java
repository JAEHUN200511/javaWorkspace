...
public class B_Cast {
	 ...
	 *       ex) 작은 바이트의 자료형 -> 큰 바이트의 자료형
	 * 2. 강제형변환 => 자동형변환이 불가능한 경우, 내가 직접 형변환 연산자를 사용하여 변환한다.
	 *       ex) 큰 바이트의 자료형 -> 작은 바이트의 자료형
	 *    형변환 연산자 ==> (바꿀 자료형) 값
	 */
	...
	public void autoCasting() {
		...
		// 정수가 실수에 담길 때에는 큰 사이즈의 정수에도 작은 사이즈의 실수에 대입 가능.
	...
	public void forceCasting() {
		...
		// 1. double -> int 
		double d1 = 10.89;
		int i1 = (int) d1; // 10.89 -> 10 실수에서 정수로 강제형변환시 소수점 부분은 버림
